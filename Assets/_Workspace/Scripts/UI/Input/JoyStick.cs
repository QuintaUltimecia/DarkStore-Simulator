...
public class JoyStick : MonoBehaviour, IDragHandler, IEndDragHandler, IInput, IBeginDragHandler
{
    ...
    protected void Awake()
    {
        ...
        _stickImage = _stickTransform.GetComponent<Image>();
        _borderImage = _borderTransform.GetComponent<Image>();
    ...
    {
        _borderImage.color = new Color(_borderImage.color.r, _borderImage.color.g, _borderImage.color.b, value);
        _stickImage.color = new Color(_stickImage.color.r, _stickImage.color.g, _stickImage.color.b, value);
    }
}
